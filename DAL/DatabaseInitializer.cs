...
namespace DAL
{
    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        private readonly ApplicationDbContextMongo _context;
        private readonly IAccountManager _accountManager;
        private readonly ILogger _logger;

        public DatabaseInitializer(ApplicationDbContextMongo context, IAccountManager accountManager, ILogger<DatabaseInitializer> logger)
        {
        ...
        {
            if ( (await _context.Users.Find(a =>  1 == 1).ToListAsync()).Count ==0)
            {
                ...
                await CreateUserAsync("admin", "tempP@ss123", "Inbuilt Administrator", "admin@company.com", "+1 (123) 000-0000", new string[] { adminRoleName });
                await CreateUserAsync("user", "tempP@ss123", "Inbuilt Standard User", "user@company.com", "+1 (123) 000-0001", new string[] { userRoleName });
        ...
        private async Task SeedDemoDataAsync()
        {
            ...
            if (true)
            {
              ...
              //  var collection = _context.Database.GetCollection<BsonDocument>("ProductCategory");

              //  List<ProductCategory> catIDs = collection.in
              ...
              var prod_1 = new Product
                ...
                _context.Customers.InsertOne(cust_1);
                _context.Customers.InsertOne(cust_2);
                _context.Customers.InsertOne(cust_3);
                _context.Customers.InsertOne(cust_4);

                _context.Products.InsertOne(prod_1);
                _context.Products.InsertOne(prod_2);

                _context.Orders.InsertOne(ordr_1);
                _context.Orders.InsertOne(ordr_2);
